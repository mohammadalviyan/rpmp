...
type Querier interface {
	...
	GetUseCaseSnapshotRows(ctx context.Context, useCaseID pgtype.UUID) ([]GetUseCaseSnapshotRowsRow, error)
	...
	ListUseCaseSnapshotRows(ctx context.Context, arg ListUseCaseSnapshotRowsParams) ([]ListUseCaseSnapshotRowsRow, error)
